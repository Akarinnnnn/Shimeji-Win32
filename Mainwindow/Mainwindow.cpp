...
WCHAR WCName[MAX_LOADSTRING];            // 主窗口类名
...
int APIENTRY _wWinMain(_In_ HINSTANCE hInstance,
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MAINWINDOW, WCName, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MAINWINDOW));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowExW(0, WCName, Title, WS_OVERLAPPEDWINDOW,
